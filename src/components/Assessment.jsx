  ...
  return (
    <div className="assessment-container">
      ...
      <form onSubmit={handleSubmit} className="assessment-form">
        ...
        <div className="form-group"><label className="form-label">Your Interests & Hobbies</label><input type="text" className="form-input" placeholder="e.g., Building web apps, AI, Video Games" value={interests} onChange={(e) => setInterests(e.target.value)} /></div>
